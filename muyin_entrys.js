...
var script='<script>var YD={};YD.showEntry=function(entrys){if(location.href.indexOf("edit")===-1){entrys.each(function(){var ifshow=($(this).attr("href").indexOf("javascript")!==-1);if(ifshow){$(this).parent().hide()}else{$(this).parent().show()}})}};YD.showEntry($(".entry-box a"));</script>';
